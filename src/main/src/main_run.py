...
class LaneFollower:
    ...
    def __init__(self):
        ...
        self.pid_kp = rospy.get_param("~steering_kp", -0.0035)
        self.pid_ki = rospy.get_param("~steering_ki", -0.00006)
        self.pid_kd = rospy.get_param("~steering_kd", -0.0006)
        self.steering_gain = self.pid_kp  # backward compatibility
        self.steering_offset = rospy.get_param("~steering_offset", 0.60)
        self.steering_smoothing = rospy.get_param("~steering_smoothing", 0.45)
        ...
        self.max_servo_delta = rospy.get_param("~max_servo_delta", 0.05)
